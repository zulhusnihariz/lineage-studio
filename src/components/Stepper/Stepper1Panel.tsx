  ...
  return (
    <section className="bg-white mx-2">
      <div className="lg:grid max-h-screen lg:grid-cols-12">
        <aside
          className="relative block h-96 lg:order-last lg:col-span-5 lg:h-full xl:col-span-5"
        >
        ...
        <main
          className="flex items-center justify-center px-2 py-10 lg:py-20 sm:px-2 lg:col-span-7 lg:px-2 lg:py-10 xl:col-span-7 lg:mx-10"
        >
              ...
              <form action="" className="space-y-4 lg:pt-6 pb-10">
                ...
                <div className="group flex justify-end relative px-3">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.0" stroke="currentColor" className="w-4 h-4">
                    ...
                    <span className="group-hover:opacity-100 transition-opacity bg-gray-800 p-2 text-[10px] text-gray-100 rounded-md absolute right-0
                    -translate-y-16 opacity-0 m-4 mx-auto">
                      Select the appropriate blockchain network for your NFT. Input the NFT's specific address and token ID to ensure accurate identification and seamless integration.
                    </span>
                </div>
